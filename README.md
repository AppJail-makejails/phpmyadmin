...
* `pma_tag` (default: `13.4-php82-apache`): see [#tags](#tags).
...
| ------------------- | ------- | -------------- | ------ | ------------- |
| `13.4-php82-apache` | `amd64` | `13.4-RELEASE` | `thin` |      `82`     |
| `13.4-php82-fpm`    | `amd64` | `13.4-RELEASE` | `thin` |      `82`     |
| `14.2-php82-apache` | `amd64` | `14.2-RELEASE` | `thin` |      `82`     |
| `14.2-php82-fpm`    | `amd64` | `14.2-RELEASE` | `thin` |      `82`     |
