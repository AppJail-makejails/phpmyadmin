...
require_once '/usr/local/www/phpMyAdmin/config.secret.inc.php';
require_once '/usr/local/www/phpMyAdmin/helpers.php';
...
if (! defined('PMA_SSL_DIR')) {
    define('PMA_SSL_DIR', $_ENV['PMA_SSL_DIR'] ?? '/usr/local/www/phpMyAdmin/ssl');
}
...
if (file_exists('/usr/local/www/phpMyAdmin/config.user.inc.php')) {
    include '/usr/local/www/phpMyAdmin/config.user.inc.php';
}

/* Support additional configurations */
if (is_dir('/usr/local/www/phpMyAdmin/conf.d/')) {
    foreach (glob('/usr/local/www/phpMyAdmin/conf.d/*.php') as $filename) {
        include $filename;
    }
}
